...
import {
    ...
    extractRecipeNotes,
    extractIngredientHeaderAndCount,
...
const scrapeRecipeUrlService = async (originalUrl, userId) => {
    ...
    try {
        ...
        console.log("Extracting ingredient headers and counts...");
        recipeData.ingredientHeadersAndCounts = extractIngredientHeaderAndCount(htmlContent, config);
        console.log("Ingredient headers and counts extracted:", recipeData.ingredientHeadersAndCounts);
        ...
        // Extract ingredient headers and count
        recipeData.ingredientHeadersAndCounts = ingredientHeadersAndCounts;

        // Now normalize the recipe data
        console.log("Normalizing recipe data...");
        recipeData = normalizeRecipeData(recipeData);
        console.log("Recipe data normalized.");
