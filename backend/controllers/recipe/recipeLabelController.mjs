...
import RecipeLabel from '../../models/sequelize/recipe/RecipeLabel.mjs'; // Adjust the path as necessary
...
} from '../../services/sequelize/recipe/recipeLabelService.mjs'; // Update the import path as needed
